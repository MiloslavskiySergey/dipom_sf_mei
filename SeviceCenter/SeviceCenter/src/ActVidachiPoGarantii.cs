...
public class ActVidachiPoGarantii : Form
{
	...
	public ActVidachiPoGarantii(DataTable dtabe, Form1 mf, string valuta)
	{
		...
		if (dtabe.Rows.Count > 0)
		{
			...
			int index = 0;
			string text = File.ReadAllText("Shablon_act_vidachiGarantii.htm");
	...
	private void InitializeComponent()
	{
            ...
            this.button2.Location = new System.Drawing.Point(1235, 60);
            ...
            this.button1.Location = new System.Drawing.Point(1235, 122);
            ...
            this.ReAktor.Location = new System.Drawing.Point(1235, 641);
            ...
            this.PrintButton.Location = new System.Drawing.Point(1235, 0);
            ...
            this.Text = "Акт выдачи по гарантии";
