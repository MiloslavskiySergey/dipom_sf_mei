...
public class VirtualClient
{
	...
	public VirtualClient(string id, string data_priema, string data_vidachi, string data_predoplaty, string surname, string phone, string aboutUs, string whatRemont, string brand, string model, string serialNumber, string sostoyanie, string komplektnost, string polomka, string kommentarij, string predvaritelnaya_stoimost, string predoplata, string zatrati, string okonchatelnaya_stoimost_remonta, string skidka, string status_remonta, string master, string vipolnenie_raboti, string garanty, string wait_zakaz, string adress, string image_key, bool diagnosik, string adressSc, string deviceColour, int clientId = -1, string barcode = "")
	{
		Id = id;
